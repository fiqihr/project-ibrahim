    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-3">
        ...
        <div class="flex mt-6 items-center justify-between">
            ...
            <a href="{{ route('products.create') }}">
                <button class="bg-gray-100 hover:bg-gray-200 px-10 py-2 rounded-md font-semibold">Add</button>
            </a>
        </div>
        ...
        <div class="grid md:grid-cols-3 grid-cols-1 mt-4 gap-6">
            @foreach ($products as $product)
                <div class="border rounded-md p-4 shadow-md">
                    <img src="{{ url('storage/' . $product->foto) }}" alt="{{ $product->nama }}"
                    ...
                    <a href="{{ route('products.edit', $product) }}">
                        <button
                            class="bg-gray-100 hover:bg-gray-200 px-10 py-2 w-full rounded-md font-semibold">Edit</button>
                    </a>
                </div>
            @endforeach
        </div>
